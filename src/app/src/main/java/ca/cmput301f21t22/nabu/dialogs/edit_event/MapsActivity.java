...
import ca.cmput301f21t22.nabu.BuildConfig;
...
public class MapsActivity extends AppCompatActivity
    ...
    private void geoLocateSearching(){
        Log.d(TAG, "geoLocate: geolocating");

        String searchingString = SearchText.getText().toString();
        ...
        if (list.size()>0){
            ...
            map.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(address.getLatitude(),address.getLongitude()),15));
