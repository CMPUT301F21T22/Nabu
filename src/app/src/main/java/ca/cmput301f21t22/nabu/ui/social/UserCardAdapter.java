...
import ca.cmput301f21t22.nabu.ui.habits.HabitCardAdapter;

public class UserCardAdapter extends RecyclerView.Adapter<UserCardAdapter.ViewHolder> {
    @NonNull
    private List<HabitCard> cards;
    @Nullable
    private ItemClickListener<UserCardAdapter, HabitCard> habitCardClickListener;
    @Nullable
    ...
    public UserCardAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UserCardAdapter.ViewHolder(binding, new EventCardAdapter());
    }
    ...
    public void setHabitCardClickListener(@Nullable ItemClickListener<UserCardAdapter, HabitCard> habitCardClickListener) {
