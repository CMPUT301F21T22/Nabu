 ...
 */
public class SocialHabitCardAdapter extends
        RecyclerView.Adapter<SocialHabitCardAdapter.ViewHolder> {
    @NonNull
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(
                CardSocialHabitBinding.inflate(LayoutInflater.from(parent.getContext()), parent,
                        false));
    }
     ...
     * @param position
     *  The integer position, within the cards list, of the HabitCard to take information from.
     */
    @Override
     ...
     * @return
     *  The integer amount of the habits that should be adapted.
     */
    @Override
     ...
     * @param cards
     *  A MyDayCard List of MyDayCards to be adapted.
     */
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
         ...
         * @param card
         *  The MyDayCard to take data from to display.
         */
