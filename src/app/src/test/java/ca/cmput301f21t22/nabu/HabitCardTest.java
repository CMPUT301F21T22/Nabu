...
public class HabitCardTest {
    ...
    public void testEquals() {
        ...
        HabitCard habitCard4 = new HabitCard(
                new Habit("Pet Dog", "They're a good boy", new GregorianCalendar(1989 + 1900, 12, 13).getTime(),
    ...
    private HabitCard mockHabitCard() {
        Habit habit = new Habit("Pet Dog", "They're a good boy", new GregorianCalendar(89 + 19, 12, 13).getTime(),
